...
sdm <- read_csv("outputs/pa_ov_GBIF.csv")
head(sdm)
...
write_csv(interpolation_gap_sdm, "outputs/interpolation_gap_GBIF.csv")
...
write_csv(combined, "outputs/targetRepresentation_taxonomicDetails_GBIF.csv")
